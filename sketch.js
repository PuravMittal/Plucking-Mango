//stands for different constants 
...
//stands for different variables
...
function setup() {
  ...
  //creates world for physics world
	world = engine.world;

  //creates stone 
	stone = new Stone(235,420,30); 

  //stands for mangoes on trees
...
function draw() {
  ...
  //creates boy variable
  image(boy ,200,340,200,300);
  
  //displays different variables
  tree.display();
  stone.display();
